...
A simple to use GitHub Action that creates and updates `dnf` compatible repository configuration commits them to a specific branch.
...
Add a new step with `uses: teragrep/dfg_01@main` to your workflow.
