...
|`location_prefix`
|Expert setting. Sets the location prefix. Mostly useful only when using a repository manager that requires relative paths and a url rewriting proxy which redirects requests to the correct location.
